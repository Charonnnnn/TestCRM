...
class CourseRecordAdmin(admin.ModelAdmin):
    ...
    def initialize_studyrecords(self, request, queryset):   # action
        ...
        for enroll_obj in queryset[0].from_class.enrollment_set.all():
            # models.StudyRecord.objects.get_or_create(   # get_or_create
            #     student = enroll_obj,
        ...
        try:
            models.StudyRecord.objects.bulk_create(new_obj_list) # 批量创建  bulk_create
